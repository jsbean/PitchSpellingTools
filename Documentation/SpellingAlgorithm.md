...
In this algorithm, optimum spellings for each `Dyad` comprising the given `PitchSet` is sought. This process continues until all `Pitch` values have been identified a best-suited `PitchSpelling`.
