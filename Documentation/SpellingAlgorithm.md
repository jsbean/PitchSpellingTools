...
In this algorithm, optimum spellings for each `Dyad` comprising the given `PitchSet` are sought. This process continues until all `Pitch` values have been identified a best-suited `PitchSpelling`.
